...
import { Shield, Calendar, Play, ArrowRight, Plus } from "lucide-react";
...
export default function CTA() {
  ...
  return (
    <section ref={ref} className="w-full bg-[#0B0F19] py-16 px-4 sm:px-6 lg:px-16 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center px-6 sm:px-12 lg:px-20 py-16 sm:py-20 gap-7">
            ...
            >
              <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold px-8 py-3.5 rounded-xl transition-all duration-300 shadow-lg shadow-blue-600/25 hover:scale-[1.02] active:scale-[0.98] text-sm">
                <Calendar size={16} />
                Book a Consultation
              </button>
              <button className="w-full sm:w-auto flex items-center justify-center gap-2 border border-white/15 hover:border-white/30 bg-white/5 hover:bg-white/10 text-white font-semibold px-8 py-3.5 rounded-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] text-sm">
