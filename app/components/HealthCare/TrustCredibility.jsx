    ...
    <section className="w-full bg-[#0B0F19] py-20 px-4 sm:px-6 lg:px-16 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10 flex flex-col gap-14">
        <motion.div
          ...
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 text-white/80  text-[10px] font-semibold uppercase tracking-widest px-4 py-2 rounded-full mb-5">
